...
// OvirtClusterSpec defines the desired state of OvirtCluster
type OvirtClusterSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file
}

// OvirtClusterStatus defines the observed state of OvirtCluster
...
// OvirtCluster is the Schema for the ovirtclusters API
